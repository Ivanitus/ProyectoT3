...
public class TableableModel extends DefaultTableModel {
	...
	//Este iveride evita que las celdas de la tabla sean modificables
	@Override
	...
	//Rellena la tabla con el ArrayList recibido, si le pasamos true tambien borrara los datos previos
	public void rellenarTabla(ArrayList<? extends Tableable> lista, boolean vaciar) {
		...
		while(it.hasNext()) {
			Tableable t = it.next();
			//Obetenemos la cabecera del modelo que implemento tableable y se lo establecemos como titulos de las columnas
