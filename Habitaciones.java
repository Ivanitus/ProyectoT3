...
public class Habitaciones implements Tableable {
	...
	public String[] getHeader() {
		String[] header = { "N∫ HABITACI”N", "SUPERFICIE", "TIPO", "N∫ BA—OS", "N∫ CAMAS", "PRECIO", "JACUZZI",
	...
	public String toString() {
		...
		mensaje += "\n\tTipo: " + tipo;
		mensaje += "\n\tNumero de ba√±os: " + numero_banos;
		mensaje += "\n\tNumero de camas: " + camas;
		mensaje += "\n\tPrecio de la habitaci√≥n por d√≠a: " + precio_habitaciones;
		if (jacuzzi) {
			mensaje += "\n\tJacuzzi: SI";
		} else {
			mensaje += "\n\tJacuzzi: NO";
